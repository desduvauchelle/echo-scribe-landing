...
export function useGsap(
  ...
  // deps are intentionally forwarded from the caller so the animation re-runs
  // when the caller's dependencies change — a non-literal dep list the static
  // rules can't verify, which is expected for a generic hook like this.
